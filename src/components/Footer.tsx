    ...
    <footer className="bg-black dark:bg-black">
      ...
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4 md:px-[135px] py-6 lg:py-8">
          <div>
            <h2 className="mb-6 text-[24px] font-semibold text-white dark:text-white">
              About Us.
            </h2>
          ...
          <div>
            <h2 className="mb-6 text-[24px] font-semibold dark:text-white text-white">
              Useful Links
            </h2>
        ...
        <div className="w-[100%] px-4 py-6 text-black dark:bg-[#FF9F0D] md:flex md:items-center md:justify-between">
